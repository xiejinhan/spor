...
func try_reloc2_sa(s1, s2 int, i1, i2 int, lss *LSS) (delta float64) {
	...
	delta = d_reloc2_sa(lss.ss[s1], lss.ss[s2], i1, i2, lss.ssr[s1], lss.ssr[s2], lss.ssqty[s2], lss.ssdur[s2], lss.sswei[s2], lss.ssdist[s2], lss)
...
//组间交换，一个route的1个点插入另一个route中
func d_reloc2_sa(s1, s2 []int, i1, i2 int, r1, r2 int, qty2 float64, dur2 float64, wei2 float64, dist2 float64, lss *LSS) (delta float64) {
	n1 := make([]int, 3)
	if i1 > 0 {
		n1[0] = lss.taskLoc[s1[i1-1]]
	}
...
func try_reloc3_sa(s1, s2 int, i1, i2 int, lss *LSS) (delta float64) {
	...
	var pivot bool
	delta, pivot = d_reloc3_sa(lss.ss[s1], lss.ss[s2], i1, i2, lss.ssr[s1], lss.ssr[s2], lss.ssqty[s2], lss.ssdur[s2], lss.sswei[s2], lss.ssdist[s2], lss)
...
//组间交换，一个route中点一段线段(连续两点)，插入另一route中
func d_reloc3_sa(s1, s2 []int, i1, i2 int, r1, r2 int, qty2 float64, dur2 float64, wei2 float64, dist2 float64, lss *LSS) (delta float64, pivot bool) {
	n1 := make([]int, 4)
	n2 := make([]int, 2)
...
func try_reloc4_sa(s1, s2 int, i1, i2 int, lss *LSS) (delta float64) {
	...
	var pivot bool
	delta, pivot = d_reloc4_sa(lss.ss[s1], lss.ss[s2], i1, i2, lss.ssr[s1], lss.ssr[s2], lss.ssqty[s2], lss.ssdur[s2], lss.sswei[s2], lss.ssdist[s2], lss)
...
//选取route1的连续5个点，route2的连续2个点，将route1中间3个点插入route2的两个点中
func d_reloc4_sa(s1, s2 []int, i1, i2 int, r1, r2 int, qty2 float64, dur2 float64, wei2 float64, dist2 float64, lss *LSS) (delta float64, pivot bool) {
	n1 := make([]int, 5)
	n2 := make([]int, 2)
